...
while($res=mysqli_fetch_array($table))
{
    ...
    <td><?php echo $x; ?></td>
      ...
      <td><a href="studentedit.php?rn=<?php echo $res['rollno'];?>" class='btn btn-info' >Edit</a></td>
      <td>
        <a href="studentdelete.php?rn=<?php echo $res['rollno']; ?>" class='btn btn-danger' >Delete</a>
